    ...
    <div class="page cv-content">
      <div class="cv-header cv-two-column cv-section" v-if="!!header">
        <div class="cv-info">
          ...
          <div
            class="cv-contact"
            v-for="(item, index) in header.contact"
            v-bind:key="index"
          >
            {{ item }}
          </div>
      ...
      <div class="cv-two-column" v-if="!!education">
        <div class="cv-section education cv-left-column">
          ...
          <div v-for="(edu, eindex) in education.content" v-bind:key="eindex">
            <div class="cv-two-column">
              <div class="cv-left-column cv-school">
        ...
        <div class="cv-section honor cv-right-column" v-if="!!honor">
          ...
          <div
            class="cv-two-column"
            v-for="(h, hindex) in honor.content"
            v-bind:key="hindex"
          >
      ...
      <div class="cv-section experience" v-if="!!experience">
        ...
        <ul class="cv-experience-list">
          <li
            ...
            v-for="(exp, eindex) in experience.content"
            v-bind:key="eindex"
          >
            <div class="cv-two-column cv-experience-header">
              <div class="cv-left-column cv-experience-title">
                {{ exp.name }}
              </div>
            ...
            <ul class="cv-experience-sub-item">
              <li
                class="cv-li"
                v-for="(expc, exindex) in exp.content"
                v-bind:key="exindex"
              >
                {{ expc }}
              </li>
      ...
      <div class="cv-section coding">
        ...
        <div
          class="cv-coding-item"
          v-for="(cod, cindex) in coding.content"
          v-bind:key="cindex"
        >
          <div class="cv-two-column">
